Supper simple mastermind number guessing game. User enters amount of digits, and the amount of tries they would like. The system then asks the user to enter a size between 1 and 7 indicating the length.
